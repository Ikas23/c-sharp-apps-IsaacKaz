...
namespace c_sharp_apps_IsaacKaz.transportation_app
{
    ...
    public class Table : Furniture
    {
            ...
            public Table(string color, decimal width, string material, decimal length, decimal height, decimal weight, bool fragile)
            ...
            {
                this.packaged = true;
                Console.WriteLine("the item has been package");
            }
            public override void UnPackage()
            {
                this.packaged = false;
                Console.WriteLine("the item has been unpackage");
            }
